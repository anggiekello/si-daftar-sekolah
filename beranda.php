    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Pendaftaran Siswa SMAN4 Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nik</th><th>Nama</th><th>Tempat Lahir</th><th>Tanggal Lahir</th><th>Telepon</th>
                            </tr>
                        </thead>
                        <tbody>
